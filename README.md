...
changed since a baseline year. Zoom into the United States and the same view
drills into all 51 states.
...
![density and drill-down](docs/img/density.png)
...
![state drill-down, dark](docs/img/states-dark.png)
